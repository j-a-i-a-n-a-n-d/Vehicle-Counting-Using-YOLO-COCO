...
video = cv2.VideoCapture(
    'D:/Vehicle Counting Deep Learning/Yolov3 learning/highway.mp4')
...
# set path of coco dataset names
with open('D:/Vehicle Counting Deep Learning/Yolov3 learning/yolo-coco/coco.names') as f:
    # Getting labels reading every line
    # and putting them into the list
    labels = [line.strip() for line in f]


network = cv2.dnn.readNetFromDarknet('D:/Vehicle Counting Deep Learning/Yolov3 learning/yolo-coco/yolov3.cfg',
                                     'D:/Vehicle Counting Deep Learning/Yolov3 learning/yolo-coco\yolov3.weights')  # set path for yolo3 weights
...
# after non-maximum suppression
    ...
    if writer is None:
        ...
        writer = cv2.VideoWriter('D:/Vehicle Counting Deep Learning/Yolov3 learning/highwayOut2.mp4', fourcc, 30,
